...
use webbeds\hotel_api_sdk\model\HotelIterator;
...
class GetHotelsResp extends ApiResponse
{
    ...
    public function __construct(array $rsData)
    {
        ...
        //echo ( isset($this->hotels['hotel'])? "hotels isset:yes\r\n" : "hotels isset:no\r\n");
        //echo ( is_null($this->hotels['hotel'])? "hotels is_null:yes\r\n" : "hotels is_null:no\r\n");
        //echo ( empty($this->hotels['hotel'])? "hotels empty:yes\r\n" : "hotels empty:no\r\n");
